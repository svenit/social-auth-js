...
var defaultOptions = {
  ...
  storageNamespace: 'social-auth-js',
  cookieStorage: {
...
var SocialAuth = function SocialAuth($http, overrideOptions) {
  var options = objectExtend({}, defaultOptions);
 ...
 */
SocialAuth.prototype.getToken = function getToken () {
 ...
 */
SocialAuth.prototype.authenticate = function authenticate (provider, userData, requestOptions) {
    var this$1 = this;
